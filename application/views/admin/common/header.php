...
<meta name="theme-color" content="#ffffff">
  ...
  <link href="<?php echo base_url(); ?>assets/bootstrap/css/bootstrap-switch.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>assets/bootstrap/css/bootstrap-switch.min.css" rel="stylesheet">

  <script src="<?php echo base_url(); ?>assets/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/js/toggles.js"></script>
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/toggles.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/themes/toggles-light.css">
