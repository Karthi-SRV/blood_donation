							...
							<div id="carousel-1" class="carousel slide">
									...
									<div class="carousel-inner">
											...
											<div class="item active">
													<img src="<?php echo base_url();?>assets/img/slider/slide1.jpg" height="400" alt="">
											...
											<!-- Begin Slide 2 -->
											<div class="item">
													<img src="<?php echo base_url();?>assets/img/slider/slide4.jpg" height="400" alt="">
													<div class="carousel-caption">
											...
											<!-- Begin Slide 3 -->
											<div class="item">
													<img src="<?php echo base_url();?>assets/img/slider/slide2.jpg" height="400" alt="">
													<div class="carousel-caption">
					...
					<div class="row services-row services-row-head services-row-1">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="services-group wow animated fadeInLeft" data-wow-offset="40">
											<p class="services-icon"><span class="fa fa-pagelines fa-5x"></span></p>
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="services-group wow animated zoomIn" data-wow-offset="40">
											<p class="services-icon"><i class="fa fa-facebook fa-5x"></i></p>
